...
from ultralytics_yolo11.solutions.solutions import BaseSolution, SolutionResults  # Import a parent class
from ultralytics_yolo11.utils import plt_settings
