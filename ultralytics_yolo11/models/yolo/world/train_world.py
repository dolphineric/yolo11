...
from ultralytics_yolo11.data import YOLOConcatDataset, build_grounding, build_yolo_dataset
from ultralytics_yolo11.data.utils import check_det_dataset
from ultralytics_yolo11.models.yolo.world import WorldTrainer
from ultralytics_yolo11.utils import DATASETS_DIR, DEFAULT_CFG, LOGGER
from ultralytics_yolo11.utils.checks import check_file
from ultralytics_yolo11.utils.torch_utils import unwrap_model
...
class WorldTrainerFromScratch(WorldTrainer):
    ...
    def check_data_config(data: dict | str | Path) -> dict:
        ...
        if not isinstance(data, dict):
            from ultralytics_yolo11.utils import YAML
