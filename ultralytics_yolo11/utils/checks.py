...
def check_file(file, suffix="", download=True, download_dir=".", hard=True):
    ...
    if (
        ...
        from ultralytics_yolo11.utils.callbacks.platform import resolve_platform_uri
...
def check_yolo(verbose=True, device=""):
    ...
    from ultralytics_yolo11.utils.torch_utils import select_device
...
def collect_system_info():
    ...
    from ultralytics_yolo11.utils import ENVIRONMENT  # scope to avoid circular import
    from ultralytics_yolo11.utils.torch_utils import get_cpu_info, get_gpu_info
...
def is_intel():
    ...
    """
    from ultralytics_yolo11.utils.torch_utils import get_cpu_info
