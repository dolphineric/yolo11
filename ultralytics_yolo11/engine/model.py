...
from ultralytics_yolo11.cfg import TASK2DATA, get_cfg, get_save_dir
from ultralytics_yolo11.engine.results import Results
from ultralytics_yolo11.nn.tasks import guess_model_task, load_checkpoint, yaml_model_load
...
class Model(torch.nn.Module):
    ...
    def __init__(
        ...
        if self.is_hub_model(model):
            from ultralytics_yolo11.hub import HUBTrainingSession
    ...
    def is_hub_model(model: str) -> bool:
        ...
        Examples:
            ...
            False
        """
        from ultralytics_yolo11.hub import HUB_WEB_ROOT
    ...
    def track(
        ...
        **kwargs: Any,
        ...
        if not hasattr(self.predictor, "trackers"):
            from ultralytics_yolo11.trackers import register_tracker
    ...
    def benchmark(self, data=None, format="", verbose=False, **kwargs: Any):
        ...
        """
        self._check_is_pytorch_model()
        from ultralytics_yolo11.utils.benchmarks import benchmark
    ...
    def tune(
        ...
        **kwargs: Any,
        ...
        self._check_is_pytorch_model()
        if use_ray:
            from ultralytics_yolo11.utils.tuner import run_ray_tune
