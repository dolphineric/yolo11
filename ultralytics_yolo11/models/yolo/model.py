...
from ultralytics_yolo11.data.build import load_inference_source
from ultralytics_yolo11.engine.model import Model
from ultralytics_yolo11.models import yolo
from ultralytics_yolo11.nn.tasks import (
    ClassificationModel,
    DetectionModel,
    OBBModel,
    PoseModel,
