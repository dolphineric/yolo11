...
from ultralytics_yolo11.cfg import TASK2DATA, TASK2METRIC, get_cfg, get_save_dir
from ultralytics_yolo11.utils import DEFAULT_CFG, DEFAULT_CFG_DICT, LOGGER, NUM_THREADS, checks, colorstr
