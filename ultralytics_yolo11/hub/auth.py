...
from ultralytics_yolo11.hub.utils import HUB_API_ROOT, HUB_WEB_ROOT, PREFIX, request_with_credentials
from ultralytics_yolo11.utils import IS_COLAB, LOGGER, SETTINGS, emojis
