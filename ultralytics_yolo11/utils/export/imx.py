...
from ultralytics_yolo11.nn.modules import Detect, Pose, Segment
from ultralytics_yolo11.utils import IS_DEBIAN_BOOKWORM, IS_DEBIAN_TRIXIE, IS_RASPBERRYPI, IS_UBUNTU, LOGGER, WINDOWS
from ultralytics_yolo11.utils.checks import check_apt_requirements, check_requirements
from ultralytics_yolo11.utils.patches import onnx_export_patch
from ultralytics_yolo11.utils.tal import make_anchors
from ultralytics_yolo11.utils.torch_utils import copy_attr
