...
from ultralytics_yolo11.utils import checks
from ultralytics_yolo11.utils.torch_utils import smart_inference_mode
...
class MobileCLIP(TextModel):
    ...
    def __init__(self, size: str, device: torch.device) -> None:
        ...
        if not Path(file).is_file():
            from ultralytics_yolo11 import download
