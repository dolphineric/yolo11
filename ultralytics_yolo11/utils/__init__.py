...
from ultralytics_yolo11.utils.git import GitRepo
from ultralytics_yolo11.utils.patches import imread, imshow, imwrite, torch_save  # for patches
from ultralytics_yolo11.utils.tqdm import TQDM  # noqa
...
class SettingsManager(JSONDict):
    ...
    def __init__(self, file=SETTINGS_FILE, version="0.0.6"):
        ...
        from ultralytics_yolo11.utils.torch_utils import torch_distributed_zero_first
