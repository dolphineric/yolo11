...
from ultralytics_yolo11.nn.autobackend import check_class_names
from ultralytics_yolo11.nn.modules import (
    AIFI,
    C1,
    C2,
    C2PSA,
...
from ultralytics_yolo11.utils import DEFAULT_CFG_DICT, LOGGER, SETTINGS, WINDOWS, YAML, colorstr, emojis
from ultralytics_yolo11.utils.checks import REMOTE_FILE_PREFIXES, check_file, check_requirements, check_suffix, check_yaml
from ultralytics_yolo11.utils.loss import (
    E2ELoss,
    PoseLoss26,
...
from ultralytics_yolo11.utils.ops import make_divisible
from ultralytics_yolo11.utils.patches import torch_load
from ultralytics_yolo11.utils.plotting import feature_visualization
...
class DetectionModel(BaseModel):
    ...
    def init_criterion(self):
        ...
        return (
            ...
            else v8DetectionLoss(self, tal_topk=getattr(self.args, "tal_topk", 10))
        )
...
class RTDETRDetectionModel(DetectionModel):
    ...
    def init_criterion(self):
        ...
        from ultralytics_yolo11.models.utils.loss import RTDETRDetectionLoss
...
class WorldModel(DetectionModel):
    ...
    def get_text_pe(self, text, batch=80, cache_clip_model=True):
        ...
        """
        from ultralytics_yolo11.nn.text_model import build_text_model
...
class YOLOEModel(DetectionModel):
    ...
    def loss(self, batch, preds=None):
        ...
        """
        if not hasattr(self, "criterion"):
            from ultralytics_yolo11.utils.loss import TVPDetectLoss
...
class YOLOESegModel(YOLOEModel, SegmentationModel):
    ...
    def loss(self, batch, preds=None):
        ...
        """
        if not hasattr(self, "criterion"):
            from ultralytics_yolo11.utils.loss import TVPSegmentLoss
...
def torch_safe_load(weight, safe_only=False):
    ...
    """
    from ultralytics_yolo11.utils.downloads import attempt_download_asset
    ...
    try:
        with temporary_modules(
            modules={
                "ultralytics.yolo.utils": "ultralytics_yolo11.utils",
                "ultralytics.yolo.v8": "ultralytics_yolo11.models.yolo",
                "ultralytics.yolo.data": "ultralytics_yolo11.data",
            },
            attributes={
                "ultralytics_yolo11.nn.modules.block.Silence": "torch.nn.Identity",  # YOLOv9e
                "ultralytics_yolo11.nn.tasks.YOLOv10DetectionModel": "ultralytics_yolo11.nn.tasks.DetectionModel",  # YOLOv10
                "ultralytics_yolo11.utils.loss.v10DetectLoss": "ultralytics_yolo11.utils.loss.E2EDetectLoss",  # YOLOv10
    ...
    for i, (f, n, m, args) in enumerate(d["backbone"] + d["head"]):  # from, number, module, args
        ...
        if m in base_modules:
            ...
            if m in repeat_modules:
                ...
                n = 1
            if m is C3k2 or m is C3k2_CA or m is C3k2_DCN:  # for M/L/X sizes
                legacy = False
                if scale in "mlx":
                    args[3] = True
            if m is A2C2f:
            ...
            c2 = ch[f]  # CARAFE preserves channel count
            args = [c2, *args[1:]]  # replace redundant channel arg with actual ch[f]
        else:
            c2 = ch[f]
