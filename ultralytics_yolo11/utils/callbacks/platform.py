...
from ultralytics_yolo11.utils import ENVIRONMENT, GIT, LOGGER, PYTHON_VERSION, RANK, SETTINGS, TESTS_RUNNING, Retry, colorstr
...
try:
    ...
    from ultralytics_yolo11.utils.logger import ConsoleLogger, SystemLogger
    from ultralytics_yolo11.utils.torch_utils import model_info_for_loggers
...
def _upload_model(model_path, project, name, progress=False, retry=1, model_id=None):
    ...
    from ultralytics_yolo11.utils.uploads import safe_upload
