...
from ultralytics_yolo11.utils import NOT_MACOS14
from ultralytics_yolo11.utils.tal import dist2bbox, dist2rbox, make_anchors
from ultralytics_yolo11.utils.torch_utils import TORCH_1_11, fuse_conv_and_bn, smart_inference_mode
...
class RTDETRDecoder(nn.Module):
    ...
    def forward(self, x: list[torch.Tensor], batch: dict | None = None) -> tuple | torch.Tensor:
        ...
        """
        from ultralytics_yolo11.models.utils.ops import get_cdn_group
